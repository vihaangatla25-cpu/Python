...
destinations = {
    ...
    "cities": ["Toyko", "Paris", "New York"]
}

jokes = [
    "Why don't programmers like nature? Too much bugs!",
    "Why did the computer go to the doctor? Because it had a virus!",
    "Why do travelers always feel warm? Because of all their hot spot!"
]
...
def chat():
    ...
    while True:
        ...
        if "recommend" in user_input or "suggest" in user_input:
            ...
            print(Fore.RED + "TraveBot: Could you rephrase?")
